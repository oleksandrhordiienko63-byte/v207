...
- "Non-empty" means the tool reported success — if \`edit\` failed, you have not satisfied this yet; **read** and retry until one edit succeeds or you exhaust reasonable anchors
